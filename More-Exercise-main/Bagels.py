# Bagels is a deduction game you can play with a friend. 
# Your friend thinks up a random 3-digit number with no repeating digits, 
# and you try to guess what the number is. After each guess, your friend gives you three types of clues: 
...
# You can get multiple clues after each guess. 
# If the secret number is 456 and your guess is 546 the clues would be “fermi pico pico”. 
# The 6 provides “fermi” and the 5 and 4 provide “pico pico”.                               Topics covered * function returning the wrong value *typeconversion problems
